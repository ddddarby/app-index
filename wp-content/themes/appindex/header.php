	...
	<body <?php body_class(); ?>>
      ...
      <div class="about-show" id="showAbout">?</div>
        ...
        <div class="toggle-wrap">
          <h4>What kind of phone do you have?</h4>

            <!-- <label>View</label> -->
            <label for="apple" class="icon apple" value="apple"></label>
            <div class="switch-toggle switch-candy">
              <input id="apple" name="view" type="radio" value="apple" checked>
              <label for="apple" value="apple"></label>

              <input id="android" name="view" type="radio" value="android">
              <label for="android"  value="android"></label>

              <a></a>
            </div>

            <label for="android" class="icon android"  value="android"></label>
        </div>
        ...
        <div class="search-wrap">
          ...
          <form method="get" id="searchform" action="<?php echo esc_url( home_url( '/' ) ); ?>">
            ...
            <input type="submit" name="submit" class="search-submit" id="searchsubmit" value="<?php esc_attr_e( 'Search', 'appindex' ); ?>" /></span>
          </form>
        </div>
